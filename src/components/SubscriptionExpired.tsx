...
export default function SubscriptionExpired({ storeName, onCheckAgain }: SubscriptionExpiredProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-gradient-to-br from-red-50 via-orange-50 to-yellow-50 flex items-start justify-center px-4 sm:px-6 lg:px-8 py-6 sm:py-8 overflow-y-auto">
        ...
        <CardContent className="pt-6 sm:pt-8 lg:pt-10 space-y-6 sm:space-y-8">
          ...
          <div className="space-y-4 sm:space-y-5">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {/* WhatsApp */}
              <a 
                href="https://wa.me/22672210216" 
                target="_blank" 
                rel="noopener noreferrer"
                className="flex flex-col sm:flex-row items-start sm:items-center gap-3 p-4 sm:p-5 bg-green-50 border border-green-200 rounded-lg hover:bg-green-100 hover:shadow-md transition-all group"
              >
              ...
              <a 
                ...
                className="flex flex-col sm:flex-row items-start sm:items-center gap-3 p-4 sm:p-5 bg-blue-50 border border-blue-200 rounded-lg hover:bg-blue-100 hover:shadow-md transition-all group"
              >
              ...
              <a 
                ...
                className="flex flex-col sm:flex-row items-start sm:items-center gap-3 p-4 sm:p-5 bg-purple-50 border border-purple-200 rounded-lg hover:bg-purple-100 hover:shadow-md transition-all group sm:col-span-2 lg:col-span-1"
              >
          ...
          <div className="pt-4 sm:pt-6 border-t">
            <div className="grid gap-3 sm:grid-cols-[1.3fr_0.7fr] items-center bg-white/70 border border-gray-200 rounded-xl p-3 sm:p-4">
              <Button 
                ...
                disabled={checking}
                className="w-full text-base sm:text-lg h-12 sm:h-14 justify-center"
                size="lg"
              >
                {checking ? (
                  <>
              ...
              <Button
                ...
                className="w-full h-12 sm:h-14 bg-orange-500 hover:bg-orange-600 text-white"
                size="lg"
              >
                Déconnexion
              </Button>
