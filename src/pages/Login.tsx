                ...
                <div className="mb-4">
                  ...
                  <div className="flex">
                    ...
                    <input
                      ...
                      pattern="[0-9]{8}"
                      required
                      className="border rounded-r-md px-3 py-2 w-full focus:outline-none focus:ring-2 focus:ring-blue-500"
                  ...
                  {phone.length > 0 && phone.length < 8 && (
                    <p className="text-red-500 text-sm mt-1">Le numéro doit comporter 8 chiffres.</p>
                  )}
                </div>
            </div>
