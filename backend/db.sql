...
CREATE TABLE `email_settings` (
  ...
  `stock_adjustments` tinyint(1) DEFAULT 1,
  `expenses` tinyint(1) DEFAULT 1,
  `logins` tinyint(1) DEFAULT 1,
  `refunds` tinyint(1) DEFAULT 1,
  `low_stock_emails` tinyint(1) DEFAULT 1,
  `out_of_stock_emails` tinyint(1) DEFAULT 1,
  `inbox_shifts` tinyint(1) DEFAULT 1,
  `inbox_stock_signals` tinyint(1) DEFAULT 1,
  `inbox_stock_adjustments` tinyint(1) DEFAULT 1,
